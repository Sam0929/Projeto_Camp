    ...
    def handle(self, *args, **kwargs):
        if not Campeonato.objects.exists():
            ...
            for data in campeonatos_data:
                ...
                self.stdout.write(f'Campeonato criado: {campeonato.nome}')
                ...
                for participante_data in data['participantes']:
                    ...
                    self.stdout.write(f"{'Criado' if created else 'Existente'}: {participante.nome}")
                    ...
                    Inscricao.objects.create(
                        ...
                        equipe_participante=participante.equipe
                    )
